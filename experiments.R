...
experiment_lcd_compare_tests_auc(simulation = 'paper', pt_sensitivity = TRUE)
# experiment_lcd_compare_tests_auc(simulation = 'paper', pt_sensitivity = TRUE, results_file = "sens_auc_curves.Rdata")
